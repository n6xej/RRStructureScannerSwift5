...
extension ViewController  {
	...
	func queryCameraAuthorizationStatusAndNotifyUserIfNotGranted() -> Bool {
		let numCameras =  AVCaptureDevice.DiscoverySession.init(deviceTypes: [.builtInWideAngleCamera, .builtInDualCamera, .builtInTelephotoCamera], mediaType: .video, position: .front).devices
